...
Before ANY complex task, create these three files in `.agent/memory/hot/`:

1. **.agent/memory/hot/task_plan.md** — Track phases and progress
2. **.agent/memory/hot/findings.md** — Store research and discoveries
3. **.agent/memory/hot/progress.md** — Session log and test results
